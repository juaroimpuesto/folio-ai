  ...
  return (
    <div className="min-h-screen bg-[#030303] text-white selection:bg-blue-600/40 font-sans scroll-smooth">
        ...
        <div className="max-w-7xl mx-auto relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-6xl md:text-[100px] font-black tracking-tighter mb-8 leading-[0.85] uppercase text-white font-mono">
              THE <span className="text-transparent bg-clip-text bg-gradient-to-b from-white to-gray-500 tracking-tighter">FULL STACK</span> <br />
          ...
          <div className="relative flex items-center justify-center p-8 lg:p-12 rounded-[3rem] bg-white/5 border border-white/10 shadow-2xl overflow-hidden group hover:scale-[1.02] transition-transform duration-500 ease-out">
            ...
            />
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-30 px-6 py-3 bg-blue-600/70 backdrop-blur-sm rounded-full text-white text-xs font-mono uppercase tracking-widest font-bold opacity-0 group-hover:opacity-100 transition-all duration-500">
                AI + HUMAN INTEL
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-left">
            {[
              ...
              { icon: <Server className="text-green-500 group-hover:text-white" />, title: "Data Infrastructure", desc: "Designing robust relational database schemas and managing high-volume data indexing." },
              { icon: <Palette className="text-pink-500 group-hover:text-white" />, title: "Visual Engineering", desc: "Premium Photoshop editing and 3D Blender rendering for high-ticket brand assets." },
              { icon: <Lock className="text-orange-500 group-hover:text-white" />, title: "Cyber-Security", desc: "Implementing security protocols for client data and protecting digital assets from vulnerabilities." },
              { icon: <Search className="text-yellow-500 group-hover:text-white" />, title: "Technical SEO", desc: "Structuring site schema and content to dominate AI search results and SGE ecosystems." },
      ...
      <section id="systems" className="py-32 px-6 border-b border-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="mb-20 text-left">
            <h2 className="text-sm font-mono text-blue-500 uppercase tracking-[0.3em] mb-4 italic tracking-tighter font-bold">Functional Proof</h2>
            ...
            <div className="group relative grid grid-cols-1 lg:grid-cols-2 gap-12 p-8 md:p-16 rounded-[3.5rem] bg-white/[0.02] border border-white/5 hover:bg-white/[0.04] transition-all overflow-hidden text-left">
              ...
              <div className="relative z-10 text-left">
                <div className="flex items-center gap-3 mb-8">
                  ...
                  <span className="text-[10px] font-mono text-gray-500 uppercase tracking-widest font-bold underline underline-offset-4 decoration-purple-500 tracking-tighter">Customer Flow Strategy</span>
                </div>
                <h3 className="text-3xl md:text-5xl font-black uppercase mb-6 italic tracking-tighter text-purple-500 leading-none underline decoration-white/10 decoration-8">Virtual <br/><span className="text-white italic">Queuing System</span></h3>
                <p className="text-gray-400 text-sm mb-10 leading-relaxed italic font-bold">"Built to optimize the 'Wait Time Experience.' This mobile-first platform allows customers to join queues remotely, reducing onsite congestion and increasing staff efficiency."</p>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-10 font-bold uppercase tracking-widest text-gray-500">
                  <div className="flex items-start gap-4">
                    <Clock className="text-purple-500 mt-1" size={20} />
                    <div><p className="text-white text-[11px]">Flow Optimization</p><p className="text-[10px] leading-relaxed mt-1 tracking-tighter font-bold font-mono">Smart wait-time logic.</p></div>
                  </div>
                  <div className="flex items-start gap-4">
                    <TrendingUp className="text-purple-500 mt-1" size={20} />
                    <div><p className="text-white text-[11px]">Scaling Capacity</p><p className="text-[10px] leading-relaxed mt-1 tracking-tighter font-bold font-mono">Zero lag sync.</p></div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 mb-32 items-start text-left">
            <div className="space-y-8">
              <h2 className="text-5xl md:text-8xl font-black tracking-tighter uppercase italic leading-none text-white">Let's <br/><span className="text-blue-600">Integrate.</span></h2>
              <p className="text-gray-500 text-lg max-w-md font-light leading-relaxed mb-10 italic">Currently open for AI-driven technical partnerships and high-growth agency operations.</p>
              <div className="flex flex-col gap-4 text-gray-400 font-mono text-xs uppercase tracking-widest font-bold font-mono">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 uppercase font-bold text-white max-w-lg">
                ...
                <a href="https://wa.me/+639452371937" target="_blank" className="group flex items-center justify-between p-6 rounded-[1.5rem] bg-white/[0.02] border border-white/5 hover:bg-green-600 transition-all font-mono">
            ...
            <div className="p-8 md:p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/10 backdrop-blur-xl relative overflow-hidden group">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-600/5 blur-[80px]" />
              <h3 className="text-2xl font-black uppercase italic mb-8 tracking-tighter flex items-center gap-3">
                <Mail className="text-blue-500" size={24} /> Quick Message
              </h3>
